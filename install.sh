...
print_help() {
    ...
    echo "-s   Android SDK version to download. See "
    echo "-c   Download Android SDK with command line tools."
    echo "-j   Choose whether to install JDK 11 or JDK 17. Please note that JDK 17 must be preferred. This option might be removed in future."
    echo "-m   Manifest file URL."
    echo ""
